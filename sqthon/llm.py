...
# visualization. When generating SQL, ensure it's optimized and follows best practices for the specified dialect. For
# visualization, consider the data type, distribution, and the user's likely intent to suggest the most insightful
# chart type.
#
